...
این پروژه یک ماشین‌حساب ساده و کاربردی است که با استفاده از **Jetpack
Compose** در اندروید پیاده‌سازی شده است.\
هدف از ساخت این پروژه، تمرین مدیریت State، طراحی UI با Compose و
پیاده‌سازی منطق محاسباتی شبیه ماشین‌حساب‌های واقعی بوده است.
...
```
> 📌 توجه: برای نمایش صحیح تصویر، فایل اسکرین‌شات باید داخل پوشه\
> `screenshots/` در ریپازیتوری قرار بگیرد.

------------------------------------------------------------------------

## 📌 هدف از پروژه

این پروژه یک **پروژه تمرینی** برای یادگیری و تسلط بیشتر روی: - Jetpack
Compose - مدیریت State - طراحی UI در اندروید - پیاده‌سازی منطق محاسباتی
